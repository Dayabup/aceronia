...
VALUES (
    ...
    (
        'Anillo de sello con inicial en oro',
        'anillos',
        'Anillo de sello clásico con inicial personalizada en oro de 18k.',
        35.99,
        15,
        '2023-11-10',
        6,
    ...
    (
        'Anillo de oro blanco con diamantes pavé',
        'anillos',
        'Anillo de oro blanco con banda de diamantes pavé, diseño elegante.',
        1499.99,
        3,
        1,
        '2023-11-15',
    ...
    (
        'Anillo de plata con diseño de infinito',
        'anillos',
        'Anillo de plata con diseño de infinito, símbolo de eternidad.',
        29.99,
        25,
        '2023-11-20',
        12,
    ...
    (
        'Anillo de compromiso con halo de zafiros',
        'anillos',
        'Anillo de compromiso con diamante central y halo de zafiros azules.',
        1999.99,
        2,
        0,
        '2023-12-01',
    ...
    (
        'Anillo de plata con diseño boho y turquesa',
        'anillos',
        'Anillo de plata con diseño boho y turquesa, estilo étnico.',
        24.99,
        30,
        '2023-11-05',
        15,
    ...
    (
        'Anillo de oro amarillo con diseño de hojas',
        'anillos',
        'Anillo de oro amarillo con diseño de hojas, estilo naturaleza.',
        99.99,
        10,
        '2023-11-10',
        5,
    ...
    (
        'Anillo de acero inoxidable con diseño minimalista',
        'anillos',
        'Anillo de acero inoxidable con diseño minimalista y líneas limpias.',
        15.99,
        40,
        '2023-11-15',
        20,
    ...
    (
        'Anillo de plata con piedra labradorita',
        'anillos',
        'Anillo de plata con piedra labradorita, efecto iridiscente.',
        39.99,
        20,
        '2023-11-20',
        10,
